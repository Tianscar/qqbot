...
import com.tianscar.qqbot.messages.MessageFromType;
...
import com.tianscar.qqbot.RobotNotification;
    ...
    public void callEvent(Event event) {
        ...
        for (Listener listener : listeners) {
            for (Method method : listener.getClass().getMethods()) {
                ...
                if (!method.getParameterTypes()[0].isInstance(event)) {//Listener的处理函数的唯一参数必须继承Event
                    continue;
                }
